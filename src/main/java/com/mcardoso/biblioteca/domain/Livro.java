package com.mcardoso.biblioteca.domain;
...
public class Livro implements Serializable{
    ...
    @Length(min = 3, max = 100, message = "Campo TÍTULO deve ter entre 3 e 100 caracteres!")
    private String titulo;
    @NotEmpty(message = "Campo NOME DO AUTOR requerido!")
    @Length(min = 3, max = 100, message = "Campo NOME DO AUTOR deve ter entre 3 e 100 caracteres!")
